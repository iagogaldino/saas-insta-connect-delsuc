...
import type { InstaLoginResponse } from "../../lib/insta"
import { InstaConnectContext, type InstaConnectValue } from "./insta-connect-context"
import type { InstaLinkResult, InstaLoginChallengeType, InstaSessionsResult } from "./insta-connect-types"
  ...
  const connectInstagram = useCallback(
    async (username: string, password: string): Promise<InstaLinkResult> => {
      ...
      try {
        ...
        const challenge = mapChallengeLoginData(data, "", u)
